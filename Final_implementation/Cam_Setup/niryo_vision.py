...
def vision(ned2, share):
    ...
    while True:
        try:
            ...
            if results != None:
                # Find the shortest distance to the object of interest, from all the objects in the vision
                ...
                if share.getUpdate() == 0:
                    ...
                    # Store the object of inerest location into the sharedata
        ...
        if cv2.waitKey(1) == ord('q') or share.getUpdate() == 100:
            share.setUpdate(100)
            break
